...
//        String IDCardNum = "12619910127266X";
        String IDCardNum = "316";
//        System.out.println(IdCardUtil.IDCardValidate(IDCardNum));
        // System.out.println(cc.isDate("1996-02-29"));
        boolean check = isValid(IDCardNum);
        System.out.println(check);
    }

    /*********************************** 身份证验证结束 ****************************************/
    public static final Pattern PATTERN = Pattern.compile("^[1-9]\\d{5}(18|19|20|(3\\d))\\d{2}((0[1-9])|(1[0-2]))(([0-2][1-9])|10|20|30|31)\\d{3}[0-9Xx]$");

    public static boolean check(String idCardNo) throws Exception {
