...
public class QRCodeUtil {
    ...
    // 二维码尺寸
    private static final int QRCODE_SIZE = 253;
    // LOGO宽度
    ...
    public static String encodeByName(String content, String fileName) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //不含Logo，指定二维码图片名
        QRCodeUtil.encode(text, null, "", "qrcode", true);
    }
